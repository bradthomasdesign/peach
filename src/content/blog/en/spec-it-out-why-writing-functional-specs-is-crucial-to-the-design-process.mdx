...
_This is the**fourteenth** article in a series about the _[_Design Process_](__GHOST_URL__/a-simple-design-process-framework-that-will-allow-you-to-succeed/) _._
...
_This is step 14 of 17 from the_[ _Design Process Playbook_](__GHOST_URL__/a-simple-design-process-framework-that-will-allow-you-to-succeed/)  
** _Next:_**[**_Don’t Clock Out Yet: The Designer’s Role in Building It Right_**](__GHOST_URL__/dont-clock-out-yet-the-designer-s-role-in-building-it-right/)