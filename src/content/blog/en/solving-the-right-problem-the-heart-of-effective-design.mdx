...
_This is the**first** article in a series about the _[_Design Process_](__GHOST_URL__/a-simple-design-process-framework-that-will-allow-you-to-succeed/) _._
...
_This is step 1 of 17 from the_[ _Design Process Playbook_](__GHOST_URL__/a-simple-design-process-framework-that-will-allow-you-to-succeed/)  
** _Next:_**[**_Defining Success: Setting SMART Goals in Design Projects_**](__GHOST_URL__/defining-success-setting-smart-goals-in-design-projects/)