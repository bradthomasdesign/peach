...
_This is the**sixth** article in a series about the _[_Design Process_](https://bradleyt.com/a-simple-design-process-framework-that-will-allow-you-to-succeed/) _._
...
_This is step 6 of 17 from the_[ _Design Process Playbook_](https://bradleyt.com/a-simple-design-process-framework-that-will-allow-you-to-succeed/)  
** _Next:_**[**_Validating Design Ideas with Technical Partners: Bridging the Gap Between Vision and Execution_**](https://bradleyt.com/validating-design-ideas-with-technical-partners-bridging-the-gap-between-vision-and-execution/)